...
class AuthenticateUserBlind implements MessageComponentInterface
{
	protected $clients;
	...
	public function sql_authenticate_user($arr_data,$from)
	{
		...
		echo "Sending: authenticate-user-blind : $reply_data\n";
	...
	public function onOpen(ConnectionInterface $conn)
	{
		...
		echo "someone connected: authenticate-user-blind\n";
		require_once("includes/connect-db.php");
	}

	public function onMessage(ConnectionInterface $from, $msg)
	{
		echo "Received: authenticate-user-blind : $msg \n";
		$reply_data = "";
	...
	public function onClose(ConnectionInterface $conn)
	{
		...
		echo "Someone has disconnected: authenticate-user-blind\n";
	}

	public function onError(ConnectionInterface $conn, Exception $e)
	{
		echo "An error has occurred: authenticate-user-blind : {$e->getMessage()}\n";
		$conn->close();
	}
}
